  ...
  return [
    {
      ...
      tagline:
        "We're hiring across paid media — Paid Search, Paid Social, Measurement, and Creative. Remote-first, full-time. One application form covers every open role.",
      heroTint: 'accent',
      statCards: [
      ...
      roleOptions: [
        {
          id: 'paid-search-specialist',
          label: 'Paid Search Specialist',
      ...
      aboutParagraphs: [
        'AdsPerio manages paid media for ambitious brands across EdTech, FinTech, DTC, and healthcare. We are hiring across every function — search, social, measurement, and creative — because they share one bar: you own the work, and you are measured on what it actually did, not on the number the platform reports.',
        'Every role here works closely with the others. Media buyers brief creative. Creative gets tested for incrementality, not just click-through. Measurement is not a reporting function bolted on at the end — it is the thing every other role answers to.',
        'This is a strong fit if you have spent real time inside ad accounts, have grown skeptical of the numbers the platforms hand you, and want to work somewhere that treats that skepticism as the job.',
      ],
      responsibilitiesHeading: 'What every one of these roles does',
      responsibilities: [
        'Own day-to-day work on your channel for a portfolio of client accounts — structure, testing, reporting.',
        'Hold yourself to measured incremental results, not to the number the platform reports.',
        'Write the weekly account read a client actually reads — plain language, specific, admits when something did not work.',
        'Work across functions: media buyers brief creative, creative gets checked against incrementality tests, measurement sets the rules everyone else works to.',
      ...
      seoTitle: 'Paid media jobs — Paid Search, Paid Social, Measurement, Creative | AdsPerio',
      seoDescription:
        'AdsPerio is hiring across paid media: Paid Search Specialist, Paid Social Specialist, Measurement Analyst, and Creative Strategist. Remote-first, one application form.',
